...
* docs: reorganize docs/ into categorized subdirectories by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/887
* feat: add projection segment on current-period bar in charts by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/886
* feat(usage): add Today's Sessions tab to Usage Analysis by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/889
* ci: remove mutation testing job from PR workflow by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/890
* fix: use real outputTokens from assistant.message to fix CLI token undercount by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/893
* fix: resolve 30+ min cold-start freeze in VS Code extension (issue #888) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/892
* Add 4 friendly tool names by @joaquinsosamartin in https://github.com/rajbos/ai-engineering-fluency/pull/891
* Add ESLint complexity rules and step summary reporting by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/895
* refactor: extract configureBackendWizard into focused private methods by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/897
* chore: add refactor-large-function prompt by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/898
* fix: add billion (B) tier to token display formatters by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/899
* chore(cli): bump version to v0.2.0 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/901
* fix: add billion (B) tier to posh-hook Format-Tokens by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/903
* rajbos/omp token segment improvements by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/900
* feat: add SSMS Copilot session discovery and detection by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/902
* docs: add Oh-My-Posh segment and Copilot CLI statusline to README by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/904
* chore: bump versions for release (vscode-extension, visualstudio-extension, jetbrains-plugin) by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/905
* refactor: extract upsertDailyRollup into focused private helpers by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/906
* refactor: extract calculateMaturityScores into focused private helpers by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/908
* feat: add refactor-large-function agent file by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/909
* fix: propagate cache tokens in chart daily stats cost calculation by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/907
* Persist chart view/period/displayMode selection across navigation by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/911
* perf: eliminate redundant JSON.parse calls in session analysis by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/910
* refactor: consolidate modelUsage accumulation with addModelUsage helper by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/912
* feat: add refactor-large-function skill by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/913
* Refactor parseSessionFileContent: unify JSON and delta paths via processRequest helper by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/914
* feat: surface Copilot CLI chat-only sessions from session-store.db by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/915
* feat: add 4 friendly tool name(s) from issue #916 by @github-actions[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/920
* Fix N+1 inefficiency in processing OpenCode sessions by @roycornelissen in https://github.com/rajbos/ai-engineering-fluency/pull/922
* fix: avoid curl pipe to python3 to resolve Scorecard alert #63 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/925
* perf(crush): fix N+1 DB read inefficiency with mtime-based caching by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/924
* chore: bump vscode-extension version to 0.10.0 by @rajbos in https://github.com/rajbos/ai-engineering-fluency/pull/926
...
* github-actions(deps): Bump the minor-and-patch-updates group with 2 updates by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/917
* github-actions(deps): Bump hashicorp/setup-terraform from 3.1.2 to 4.0.1 by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/919
* github-actions(deps): Bump actions/cache from 4.2.3 to 5.0.5 by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/918
### 📦 Other Dependencies
...
* chore(deps-dev): Bump @types/node from 25.7.0 to 25.8.0 in /cli by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/884
* chore(deps): Bump puppeteer from 24.43.1 to 25.0.2 in /.github/scripts by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/894
* gradle(deps): bump gradle-wrapper from 9.5.0 to 9.5.1 in /jetbrains-plugin in the minor-and-patch-updates group by @dependabot[bot] in https://github.com/rajbos/ai-engineering-fluency/pull/921

## New Contributors
* @joaquinsosamartin made their first contribution in https://github.com/rajbos/ai-engineering-fluency/pull/891
* @roycornelissen made their first contribution in https://github.com/rajbos/ai-engineering-fluency/pull/922

**Full Changelog**: https://github.com/rajbos/ai-engineering-fluency/compare/vscode/v0.5.0...vscode/v0.10.0
